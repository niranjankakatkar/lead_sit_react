        ...
        <>
            <div className="header header-one">
                <Link to="/dashboard"
                    ...
                    <img src="assets/img/logo.png" className="img-fluid logo2 mt-0 h-100 w-80" alt="Logo" />
                </Link>
                ...
                <div className="sidebar-inner slimscroll">
                    <div id="sidebar-menu" className="sidebar-menu">
                        ...
                        <ul className="sidebar-vertical">
                            ...
                            <li className="menu-title"><span>Module</span></li>
                <li>
                    <Link to="/module"><i className="fe fe-user"></i> <span>Module</span></Link>
                </li>
                <li>
                    <Link to="/category"><i className="fe fe-user"></i> <span>Category</span></Link>
                </li>
                <li>
                    <Link to="/subcategory"><i className="fe fe-user"></i> <span>Sub-category</span></Link>
                </li>
                
                <li className="menu-title"><span>Employee Management</span></li>
                <li>
                    <Link to="/employee"><i className="fe fe-user"></i> <span>Employee</span></Link>
                </li>
                <li>
                    <Link to="/demo"><i className="fe fe-user"></i> <span>Demo</span></Link>
                </li>
