...
export default function User() {
  ...
  useEffect(() => {
    axios.get('http://43.205.22.150:5000/category/getAllCnt')
      .then(res => {
        console.log(res);
  ...
  useEffect(() => {
    axios.get('http://43.205.22.150:5000/category/getActiveCnt')
      .then(res => {
        console.log(res);
  ...
  useEffect(() => {
    axios.get('http://43.205.22.150:5000/category/getInactiveCnt')
      .then(res => {
        console.log(res);
