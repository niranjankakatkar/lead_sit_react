...
export default function User() {
  ...
  useEffect(() => {
    axios
      .get("http://43.205.22.150:5000/selleronboarding/getAllSeller")
      .then((res) => {
        console.log(res);
        setData(res.data);
      })
  ...
  const handleDelete = (id) => {
    axios
      .delete("http://43.205.22.150:5000/selleronboarding/deleteSingleSeller/" + id)
      .then((res) => {
        console.log(res);
        navigate("/franchisee");
      })
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .post("http://43.205.22.150:5000/selleronboarding/createSeller", {
        franchisee,
        oname,
        email,
        mobileno,
